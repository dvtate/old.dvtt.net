<!DOCTYPE html><html>
	<head>
		...
		<meta name="description" content="Find a your free online doctor. Free telemedicine."/>
		<meta name="author" content="original copy by DV Tate Testa - This is auomatically edited with user content"/>
		<title>Free Doctors - HealthIT</title>
		...
		<div class="page">
			<div class="showfakeback"><h1>Free Doctors:</h1>
				<!--php - finde og erstatte med og ny konto-->

				<a href="//dvtate.com/healthit/free/nyfakedr/"><div class="pagebox">
					<img class="profileimg" alt="user-foto" src="<?php echo file_get_contents(dirname(__DIR__).'/nyfakedr/imgurl.txt'); ?>"/>
					<div class="om-dr">
						<span class="omdr-navn"><?php echo file_get_contents(dirname(__DIR__).'/nyfakedr/name.txt'); ?></span><hr class="navn-tag"/>
						<span class="omdr-tag"><?php echo file_get_contents(dirname(__DIR__).'/nyfakedr/tag.txt'); ?></span>
					</div>
				</div></a>

				<a href="//dvtate.com/healthit/free/dvtate/"><div class="pagebox">
					<img class="profileimg" alt="user-foto" src="<?php echo file_get_contents(dirname(__DIR__).'/dvtate/imgurl.txt'); ?>"/>
					<div class="om-dr">
						<span class="omdr-navn"><?php echo file_get_contents(dirname(__DIR__).'/dvtate/name.txt'); ?></span><hr class="navn-tag"/>
						<span class="omdr-tag"><?php echo file_get_contents(dirname(__DIR__).'/dvtate/tag.txt'); ?></span>
					</div>
				</div></a>
			</div>
		</div>
